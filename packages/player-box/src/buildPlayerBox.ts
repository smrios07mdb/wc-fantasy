...
const CATEGORY_META: Record<string, { section: string; label: string; tag: string }> = {
  ...
  [CAT.shotsOnTarget]: { section: "Accumulators", label: "Shots on target", tag: "SOT" },
  [CAT.ballRecoveries]: { section: "Accumulators", label: "Ball recoveries", tag: "REC" },
  [CAT.bigChancesCreated]: { section: "Accumulators", label: "Big chances created", tag: "BCC" },
  [CAT.crossesAccurate]: { section: "Accumulators", label: "Accurate crosses", tag: "CRS" },
  [CAT.touches]: { section: "Accumulators", label: "Touches", tag: "TCH" },
