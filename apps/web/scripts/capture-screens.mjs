...
const WAVE2_SURFACES = [
  ...
  },
  {
    ...
    active: true,
    route: "/players",
    state: "nationfilter-active-band",
    phase: "knockout",
    viewports: W2_VPS,
    source: "live",
    fullPage: true,
    ...
    trigger: "/players → open Nations → select Spain → collapse toggle",
    note: "COLLAPSED header with the active-nation chip + ✕ clear control (`.nf-active`) — the 'selected band' resting state.",
  },
  {
