        ...
        <div className="mfa-scroll">
          {loading
            ...
            : rows.length===0
              ...
              : rows.map(p => <MFaRow key={p.id} p={p} t={t} onBid={onBid} onOpen={onOpen}/>)}
        </div>
      </div>
    </IOSDevice>
  );
