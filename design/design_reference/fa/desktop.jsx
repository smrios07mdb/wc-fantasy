...
function DesktopFA(props){
  const { rows, counts, t, q, setQ, pos, setPos, sort, setSort, includeOwned, setIncludeOwned,
          density, onBid, conn, theme } = props;
      ...
      <div className="fa-scroll">
        <div className="fa-page">
          ...
          {loading ? (
            ...
            <div className="fa-cards">{rows.map(p => <FaCard key={p.id} p={p} t={t} onBid={onBid}/>)}</div>
          ) : (
            <div className="fa-listcard">
              ...
              <div className="fa-list">{rows.map(p => <FaRow key={p.id} p={p} t={t} onBid={onBid}/>)}</div>
            </div>
          )}
