...
function H2HDetail({ field, oppId, onClose, openScore }) {
  const me = field.snaps.find(s=>s.id===ME_ID);
    ...
    return (
      <div className="vf-h2h-col">
        ...
        <div className="vf-h2h-list">
          {rows.map((r,i)=>(
            <button className={'vf-h2h-pl vf-statusrow-'+r.status} key={i} onClick={()=>openScore(r.p, snap.id)} title="View points breakdown">
  ...
  return (
    <div className="vf-h2hwrap card">
      ...
      <p className="t-micro text-tertiary" style={{margin:'2px 2px 0', textAlign:'center'}}>Tap any player to see the categories &amp; stats behind their points</p>
    </div>
  );
}
        ...
        <>
          ...
          <div className="vf-body">
            ...
            <div className="vf-rail">
              ...
              {!loading && (selected
                ? <H2HDetail field={field} oppId={selected} onClose={()=>setSelected(null)} openScore={openScore} />
